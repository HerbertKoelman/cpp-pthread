...
\subsubsection[{\texorpdfstring{operator=(const thread \&)=delete}{operator=(const thread &)=delete}}]{\setlength{\rightskip}{0pt plus 5cm}thread\& pthread\+::thread\+::operator= (
\begin{DoxyParamCaption}
\item[{const thread \&}]{}
\end{DoxyParamCaption}
...
\index{operator=@{operator=}!pthread\+::thread@{pthread\+::thread}}
\subsubsection[{\texorpdfstring{operator=(thread \&\&other)}{operator=(thread &&other)}}]{\setlength{\rightskip}{0pt plus 5cm}thread \& pthread\+::thread\+::operator= (
\begin{DoxyParamCaption}
\item[{thread \&\&}]{other}
\end{DoxyParamCaption}
