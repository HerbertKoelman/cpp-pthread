...
\index{pthread\+::thread@{pthread\+::thread}!thread@{thread}}
\index{thread@{thread}!pthread\+::thread@{pthread\+::thread}}
\subsubsection[{\texorpdfstring{thread(const runnable \&runner, const std\+::size\+\_\+t stack\+\_\+size=0)}{thread(const runnable \&runner, const std::size\_t stack\_size=0)}}]{\setlength{\rightskip}{0pt plus 5cm}pthread\+::thread\+::thread (
\begin{DoxyParamCaption}
\item[{const {\bf runnable} \&}]{runner, }
\item[{const std\+::size\+\_\+t}]{stack\+\_\+size = {\ttfamily 0}}
\end{DoxyParamCaption}
)}\hypertarget{classpthread_1_1thread_aaf360cff96e50499872bd147e85ba3ac}{}\label{classpthread_1_1thread_aaf360cff96e50499872bd147e85ba3ac}
create a new thread
...
\index{pthread\+::thread@{pthread\+::thread}!join@{join}}
\index{join@{join}!pthread\+::thread@{pthread\+::thread}}
\subsubsection[{\texorpdfstring{join()}{join()}}]{\setlength{\rightskip}{0pt plus 5cm}void pthread\+::thread\+::join (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}\hypertarget{classpthread_1_1thread_a90ab4afc041cf26d9fd4b289bf0224c8}{}\label{classpthread_1_1thread_a90ab4afc041cf26d9fd4b289bf0224c8}
