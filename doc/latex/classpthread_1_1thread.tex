...
\index{thread@{thread}!pthread\+::thread@{pthread\+::thread}}
\subsubsection[{\texorpdfstring{thread(const runnable \&runner, const std\+::size\+\_\+t stack\+\_\+size=0)}{thread(const runnable &runner, const std::size_t stack_size=0)}}]{\setlength{\rightskip}{0pt plus 5cm}pthread\+::thread\+::thread (
\begin{DoxyParamCaption}
