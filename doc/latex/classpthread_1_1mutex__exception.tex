...
\subsubsection[{mutex\+\_\+exception(const std\+::string message, const int pthread\+\_\+errno=0)}]{\setlength{\rightskip}{0pt plus 5cm}pthread\+::mutex\+\_\+exception\+::mutex\+\_\+exception (
