...
\subsubsection[{abstract\+\_\+thread(const std\+::size\+\_\+t stack\+\_\+size=0)}]{\setlength{\rightskip}{0pt plus 5cm}pthread\+::abstract\+\_\+thread\+::abstract\+\_\+thread (
...
{\em stack\+\_\+size} & thread\textquotesingle{}s stack size (default 0 which means use P\+T\+H\+R\+E\+A\+D\+\_\+\+S\+T\+A\+C\+K\+\_\+\+M\+I\+N) \\
\hline
\end{DoxyParams}
